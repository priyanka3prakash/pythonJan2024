...
print(f"{simple_set =}")   # {1, 2, 3}

simple_set.add(99)
print(f"{simple_set =}")   # {99, 1, 2, 3}

simple_set.add(99)
print(f"{simple_set =}")  # {99, 1, 2, 3}

simple_set.add((99,))
print(f"{simple_set =}")  # {1, 2, 99, 3, (99,)}
...
print(f"{simple_set =}") # {1, 2, 99, 3, 'Python', (99,)}
...
simple_set.update((8, 88)) # {1, 2, 3, 8, 88}
print(f"{simple_set =}")

simple_set.update([8, 7])  # {1, 2, 3, 7, 8, 88}
print(f"{simple_set =}")

simple_set.update([8, 7, (2, 3), (9,)])
print(f"{simple_set =}") # {1, 2, 3, 7, 8, (2, 3), 88, (9,)}
