...
mylist.extend([77])      #  [11, 22, 33, 44, None, [55, 66], 77]
print("After mylist.extend([77]):\n\t", mylist) 

mylist.extend((88, 99))  # [11, 22, 33, 44, None, [55, 66], 77, 88, 99]
print("After mylist.extend((88, 99)):\n\t", mylist)

mylist.extend([111, (222, 333)]) #  [11, 22, 33, 44, None, [55, 66], 77, 88, 99, 111, (222, 333)]
...
# pop -- with remove last element, by default; else at given position
