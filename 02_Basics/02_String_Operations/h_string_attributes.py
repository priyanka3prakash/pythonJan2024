...
# In [32]: "python programming".split()
# Out[32]: ['python', 'programming']

# In [33]: "python          programming".split()
# Out[33]: ['python', 'programming']

# In [34]: "python          programming".split(" ")
# Out[34]: ['python', '', '', '', '', '', '', '', '', '', 'programming']
