...
print(re.findall('class',      'today class is on classification of declassified docs'))
print(re.findall(r'\bclass\b', 'today class is on classification of declassified docs'))
print(re.findall(r'\Bclass\B', 'today class is on classification of declassified docs'))
