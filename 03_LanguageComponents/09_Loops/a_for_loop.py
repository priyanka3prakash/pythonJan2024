...
print(enumerate("Python")) # <enumerate object at 0x7f3f9ced4540>

for each_chr in "Python":
    print(type(each_chr), each_chr)

for each_pair in enumerate("Python"):
    print(type(each_pair), each_pair)
...
for each_ele in enumerate([11, 22, 33, 44, 55]):
    print(f"{each_ele[0]} ===> {each_ele[1]}") # indexing
print()

for loop_index, each_ele in enumerate([11, 22, 33, 44, 55]):
    print(f"{loop_index} ===> {each_ele}") # unpacking
print()
